...
@section('main')
    <div class="container mx-auto py-3 border-t-2 border-b border-t-gray-900 border-b-gray-300 mb-8">
        <div class="mb-3">
            <h2 class="uppercase font-bold inline text-sm"><a href="/profiles">Profiles</a></h2> |
            <time datetime="{{ date(DATE_ISO8601, $page->timestamp) }}">{{ date('D jS F Y g:ia', $page->timestamp) }}</time>
        </div>
